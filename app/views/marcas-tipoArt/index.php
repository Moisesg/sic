...
<head>
    ...
    <title>SIC | Marcas - Tipo. Articulos</title>
           ...
           <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                           <a href="../inventario/"><i class="fa fa-cube fa-fw"></i> Inventario</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a class="active" href="javascript:void(0)"><i class="fa fa-bookmark fa-fw"></i> Marcas y/o Tipo Articulos</a>
                        </li>
            ...
            <div class="row">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>Articulos en inventario</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
             ...
             <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Ultimas articulos en inventario
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bookmark fa-fw"></i> Ultimas marcas agregadas
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-th-large fa-fw"></i> Ultimos tipo art. agregados
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
